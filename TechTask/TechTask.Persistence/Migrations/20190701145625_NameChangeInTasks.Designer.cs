...
namespace TechTask.Persistence.Migrations
{
    ...
    [Migration("20190701145625_NameChangeInTasks")]
    partial class NameChangeInTasks
    {
            ...
            modelBuilder.Entity("TechTask.Persistence.Models.Users.Team", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2019, 7, 1, 17, 56, 25, 174, DateTimeKind.Local).AddTicks(6688),
                            HoursOfWorkOnAllTasks = 0,
                            Name = "Alpha",
                            UpdatedAt = new DateTime(2019, 7, 1, 17, 56, 25, 176, DateTimeKind.Local).AddTicks(3833)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2019, 7, 1, 17, 56, 25, 176, DateTimeKind.Local).AddTicks(6171),
                            HoursOfWorkOnAllTasks = 0,
                            Name = "Beta",
                            UpdatedAt = new DateTime(2019, 7, 1, 17, 56, 25, 176, DateTimeKind.Local).AddTicks(6184)
                        });
                });
            ...
            modelBuilder.Entity("TechTask.Persistence.Models.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2019, 7, 1, 17, 56, 25, 181, DateTimeKind.Local).AddTicks(5227),
                            ...
                            Role = 0,
                            TeamId = 1,
                            UpdatedAt = new DateTime(2019, 7, 1, 17, 56, 25, 181, DateTimeKind.Local).AddTicks(5254)
                        },
                        new
                        {
                            Id = new Guid("76aebd31-0235-4ef3-a123-08d6fbc1bdcd"),
                            CreatedAt = new DateTime(2019, 7, 1, 17, 56, 25, 181, DateTimeKind.Local).AddTicks(7534),
                            ...
                            Password = "John123",
                            Role = 1,
                            UpdatedAt = new DateTime(2019, 7, 1, 17, 56, 25, 181, DateTimeKind.Local).AddTicks(7548)
                        },
                        new
                        {
                            Id = new Guid("ed09fe47-84c0-47b5-8007-ae2ea4350a8b"),
                            CreatedAt = new DateTime(2019, 7, 1, 17, 56, 25, 181, DateTimeKind.Local).AddTicks(9462),
                            ...
                            Role = 0,
                            TeamId = 2,
                            UpdatedAt = new DateTime(2019, 7, 1, 17, 56, 25, 181, DateTimeKind.Local).AddTicks(9476)
                        },
                        new
                        {
                            Id = new Guid("f3c88d42-fb42-43c4-a9d4-1a738a2bd20c"),
                            CreatedAt = new DateTime(2019, 7, 1, 17, 56, 25, 181, DateTimeKind.Local).AddTicks(9516),
                            ...
                            Password = "Anthony123",
                            Role = 1,
                            UpdatedAt = new DateTime(2019, 7, 1, 17, 56, 25, 181, DateTimeKind.Local).AddTicks(9520)
                        });
                });
