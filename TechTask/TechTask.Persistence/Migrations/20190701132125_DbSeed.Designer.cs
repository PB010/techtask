...
namespace TechTask.Persistence.Migrations
{
    ...
    [Migration("20190701132125_DbSeed")]
            ...
            modelBuilder.Entity("TechTask.Persistence.Models.Users.Team", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2019, 7, 1, 16, 21, 25, 184, DateTimeKind.Local).AddTicks(625),
                            HoursOfWorkOnAllTasks = 0,
                            Name = "Alpha",
                            UpdatedAt = new DateTime(2019, 7, 1, 16, 21, 25, 185, DateTimeKind.Local).AddTicks(6079)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2019, 7, 1, 16, 21, 25, 185, DateTimeKind.Local).AddTicks(8056),
                            HoursOfWorkOnAllTasks = 0,
                            Name = "Beta",
                            UpdatedAt = new DateTime(2019, 7, 1, 16, 21, 25, 185, DateTimeKind.Local).AddTicks(8074)
                        });
                });
            ...
            modelBuilder.Entity("TechTask.Persistence.Models.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2019, 7, 1, 16, 21, 25, 190, DateTimeKind.Local).AddTicks(9165),
                            ...
                            Role = 0,
                            TeamId = 1,
                            UpdatedAt = new DateTime(2019, 7, 1, 16, 21, 25, 190, DateTimeKind.Local).AddTicks(9200)
                        },
                        new
                        {
                            Id = new Guid("76aebd31-0235-4ef3-a123-08d6fbc1bdcd"),
                            CreatedAt = new DateTime(2019, 7, 1, 16, 21, 25, 191, DateTimeKind.Local).AddTicks(1716),
                            ...
                            Password = "John123",
                            Role = 1,
                            UpdatedAt = new DateTime(2019, 7, 1, 16, 21, 25, 191, DateTimeKind.Local).AddTicks(1734)
                        },
                        new
                        {
                            Id = new Guid("ed09fe47-84c0-47b5-8007-ae2ea4350a8b"),
                            CreatedAt = new DateTime(2019, 7, 1, 16, 21, 25, 191, DateTimeKind.Local).AddTicks(3907),
                            ...
                            Role = 0,
                            TeamId = 2,
                            UpdatedAt = new DateTime(2019, 7, 1, 16, 21, 25, 191, DateTimeKind.Local).AddTicks(3921)
                        },
                        new
                        {
                            Id = new Guid("f3c88d42-fb42-43c4-a9d4-1a738a2bd20c"),
                            CreatedAt = new DateTime(2019, 7, 1, 16, 21, 25, 191, DateTimeKind.Local).AddTicks(3957),
                            ...
                            Password = "Anthony123",
                            Role = 1,
                            UpdatedAt = new DateTime(2019, 7, 1, 16, 21, 25, 191, DateTimeKind.Local).AddTicks(3961)
                        });
                });
